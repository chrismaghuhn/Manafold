# Capability Specification — rules/artifact-permanent

**Capability key/version:** `rules/artifact-permanent@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.artifact_permanent`

## Purpose

This durable V1 capability covers the Artifact card type on the public type line.

## Supported scope

- Includes: the Artifact card type on the public type line
...
- an artifact reference in rules text without the Artifact type characteristic

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.artifact_permanent`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.artifact_permanent`
- `comprehensive-rules:CR-205-type-line`
- `comprehensive-rules:CR-301-artifacts`
...
- Selected B2 family: `cap.artifact_permanent`
