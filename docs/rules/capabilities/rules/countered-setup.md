# Capability Specification — rules/countered-setup

**Capability key/version:** `rules/countered-setup@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.countered_setup`

## Purpose

This durable V1 capability covers a setup state whose defining progress is established by placing or removing a named counter.

## Supported scope

- Includes: a setup state whose defining progress is established by placing or removing a named counter
...
- an ability or spell being countered and an ordinary counter without setup-state meaning

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.countered_setup`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.countered_setup`
...
- Selected B2 family: `cap.countered_setup`
