# Capability Specification — rules/flying-grant

**Capability key/version:** `rules/flying-grant@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.flying_grant`

## Purpose

This durable V1 capability covers an effect that grants or gives the Flying keyword to a creature or permanent.

## Supported scope

- Includes: an effect that grants or gives the Flying keyword to a creature or permanent
...
- a card that already has Flying or an unrelated evasion effect

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.flying_grant`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.flying_grant`
...
- Selected B2 family: `cap.flying_grant`
