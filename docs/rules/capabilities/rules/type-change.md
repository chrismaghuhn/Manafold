# Capability Specification — rules/type-change

**Capability key/version:** `rules/type-change@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.type_change`

## Purpose

This durable V1 capability covers an effect that changes, adds, or removes a card type, subtype, or supertype.

## Supported scope

- Includes: an effect that changes, adds, or removes a card type, subtype, or supertype
...
- a printed type line, a color-only change, or a power/toughness modification

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.type_change`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.type_change`
...
- Selected B2 family: `cap.type_change`
- Selected outlier surfaces: Grimoire of the Dead [control-change;mass-reanimation;type-color-modification;cross-graveyard]; Necromantic Selection [control-change;mass-destruction;reanimation;type-color-modification].
