# Capability Specification — rules/land-zone

**Capability key/version:** `rules/land-zone@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.land_zone`

## Purpose

This durable V1 capability covers the Land card type on the public type line.

## Supported scope

- Includes: the Land card type on the public type line
...
- a land reference in rules text without the Land type characteristic

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.land_zone`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.land_zone`
