# Capability Specification — rules/draw-trigger

**Capability key/version:** `rules/draw-trigger@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.draw_trigger`

## Purpose

This durable V1 capability covers an actual triggered ability whose event or result is card draw.

## Supported scope

- Includes: an actual triggered ability whose event or result is card draw
...
- draw text in a non-triggered effect or a reminder occurrence

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.draw_trigger`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.draw_trigger`
