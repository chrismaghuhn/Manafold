# Capability Specification — rules/life

**Capability key/version:** `rules/life@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.life`

## Purpose

This durable V1 capability covers an instruction that changes a player's life total by gaining or losing life.

## Supported scope

- Includes: an instruction that changes a player's life total by gaining or losing life
...
- damage, life payment, or a life reference that does not change a life total

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.life`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.life`
