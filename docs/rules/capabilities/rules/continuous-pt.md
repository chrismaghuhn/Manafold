# Capability Specification — rules/continuous-pt

**Capability key/version:** `rules/continuous-pt@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.continuous_pt`

## Purpose

This durable V1 capability covers a continuous effect that modifies creatures' power and toughness for its stated duration.

## Supported scope

- Includes: a continuous effect that modifies creatures' power and toughness for its stated duration
...
- base-setting, one-shot, or target-specific power/toughness changes

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.continuous_pt`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.continuous_pt`
...
- Selected B2 family: `cap.continuous_pt`
