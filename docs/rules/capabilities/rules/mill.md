# Capability Specification — rules/mill

**Capability key/version:** `rules/mill@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.mill`

## Purpose

This durable V1 capability covers an instruction that puts cards from a library into a graveyard by the mill operation.

## Supported scope

- Includes: an instruction that puts cards from a library into a graveyard by the mill operation
...
- searching, revealing, drawing, or discarding cards

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.mill`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.mill`
- `comprehensive-rules:CR-404-graveyard`
- `comprehensive-rules:CR-701-17a-mill`
