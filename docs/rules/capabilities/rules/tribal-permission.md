# Capability Specification — rules/tribal-permission

**Capability key/version:** `rules/tribal-permission@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** information-safety-maintainer
**Mapping boundary:** Selected B2 family: `cap.tribal_permission`

## Purpose

This durable V1 capability covers a permission effect whose availability is explicitly conditioned on a creature type or tribal identity.

## Supported scope

- Includes: a permission effect whose availability is explicitly conditioned on a creature type or tribal identity
...
- a creature type used only in a token descriptor or an unrelated tribal effect

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.tribal_permission`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.tribal_permission`
...
- Selected B2 family: `cap.tribal_permission`
