# Capability Specification — rules/planeswalker

**Capability key/version:** `rules/planeswalker@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-interaction-maintainer
**Mapping boundary:** Selected B2 family: `cap.planeswalker`

## Purpose

This durable V1 capability covers the Planeswalker card type and its loyalty ability object class.

## Supported scope

- Includes: the Planeswalker card type and its loyalty ability object class
...
- a loyalty counter on a non-planeswalker or a planeswalker reference in ordinary text

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.planeswalker`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.planeswalker`
...
- `rules/loyalty-activation-rules`
- `rules/loyalty-counters`
...
- Selected B2 family: `cap.planeswalker`
