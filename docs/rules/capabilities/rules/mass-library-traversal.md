# Capability Specification — rules/mass-library-traversal

**Capability key/version:** `rules/mass-library-traversal@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.mass_library_traversal`

## Purpose

This durable V1 capability covers one effect that processes a plurality of cards while traversing or revealing a library.

## Supported scope

- Includes: one effect that processes a plurality of cards while traversing or revealing a library
...
- a single-card search, ordinary draw, or shuffle without mass traversal

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.mass_library_traversal`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.mass_library_traversal`
...
- Selected B2 family: `cap.mass_library_traversal`
