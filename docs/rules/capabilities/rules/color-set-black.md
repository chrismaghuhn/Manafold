# Capability Specification — rules/color-set-black

**Capability key/version:** `rules/color-set-black@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.color_set_black`

## Purpose

This durable V1 capability covers an effect that sets an object's color to black.

## Supported scope

- Includes: an effect that sets an object's color to black
...
- adding black, choosing black for mana, or a black color indicator printed on a card

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.color_set_black`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.color_set_black`
...
- Selected B2 family: `cap.color_set_black`
