# Capability Specification — rules/put-battlefield

**Capability key/version:** `rules/put-battlefield@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.put_battlefield`

## Purpose

This durable V1 capability covers an instruction that puts an object directly onto the battlefield.

## Supported scope

- Includes: an instruction that puts an object directly onto the battlefield
...
- casting a spell, returning to hand, or an ordinary battlefield reference

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.put_battlefield`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.put_battlefield`
...
- Selected B2 family: `cap.put_battlefield`
