# Capability Specification — rules/turn-scoped-permission

**Capability key/version:** `rules/turn-scoped-permission@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** information-safety-maintainer
**Mapping boundary:** Selected B2 family: `cap.turn_scoped_permission`

## Purpose

This durable V1 capability covers a permission to cast, activate, or use an object that lasts until end of turn or another stated turn boundary.

## Supported scope

- Includes: a permission to cast, activate, or use an object that lasts until end of turn or another stated turn boundary
...
- a permanent permission, a once-per-turn reset, or a turn trigger without a permission

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.turn_scoped_permission`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.turn_scoped_permission`
...
- Selected B2 family: `cap.turn_scoped_permission`
