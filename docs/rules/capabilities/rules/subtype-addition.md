# Capability Specification — rules/subtype-addition

**Capability key/version:** `rules/subtype-addition@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.subtype_addition`

## Purpose

This durable V1 capability covers an effect that adds a subtype to an object's existing type line.

## Supported scope

- Includes: an effect that adds a subtype to an object's existing type line
...
- setting or removing all types/subtypes and a printed subtype

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.subtype_addition`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.subtype_addition`
...
- Selected B2 family: `cap.subtype_addition`
