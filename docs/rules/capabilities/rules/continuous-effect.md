# Capability Specification — rules/continuous-effect

**Capability key/version:** `rules/continuous-effect@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.continuous_ability`

## Purpose

This durable V1 capability covers a continuous effect that grants, removes, or modifies an ability on the affected object.

## Supported scope

- Includes: a continuous effect that grants, removes, or modifies an ability on the affected object
...
- an activated or triggered ability itself without a continuous grant or removal

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.continuous_ability`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.continuous_ability`
