# Capability Specification — rules/subtype-add-zombie

**Capability key/version:** `rules/subtype-add-zombie@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.subtype_add_zombie`

## Purpose

This durable V1 capability covers an effect that adds Zombie as a subtype to the affected object.

## Supported scope

- Includes: an effect that adds Zombie as a subtype to the affected object
...
- creating a Zombie token, choosing a creature type, or setting a different subtype

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.subtype_add_zombie`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.subtype_add_zombie`
...
- Generated or affected objects are limited to: the permanents, players, cards, or abilities affected by the continuous effect in Includes
...
- Selected B2 family: `cap.subtype_add_zombie`
