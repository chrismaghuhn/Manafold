# Capability Specification — rules/death-trigger

**Capability key/version:** `rules/death-trigger@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.death_trigger`

## Purpose

This durable V1 capability covers an actual triggered ability whose event is a creature dying or moving from battlefield to graveyard.

## Supported scope

- Includes: an actual triggered ability whose event is a creature dying or moving from battlefield to graveyard
...
- a graveyard reference or destruction effect without a death trigger

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.death_trigger`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.death_trigger`
- `comprehensive-rules:CR-603-triggered-abilities`
- `comprehensive-rules:CR-700-general`
