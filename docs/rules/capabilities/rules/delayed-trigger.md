# Capability Specification — rules/delayed-trigger

**Capability key/version:** `rules/delayed-trigger@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.delayed_trigger`

## Purpose

This durable V1 capability covers a delayed triggered ability created now to trigger on a later stated event or time.

## Supported scope

- Includes: a delayed triggered ability created now to trigger on a later stated event or time
...
- an immediate trigger, an ordinary trigger printed on the card, or a delayed non-triggered effect

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.delayed_trigger`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.delayed_trigger`
...
- Selected B2 family: `cap.delayed_trigger`
