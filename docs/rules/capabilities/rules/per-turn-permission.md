# Capability Specification — rules/per-turn-permission

**Capability key/version:** `rules/per-turn-permission@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** information-safety-maintainer
**Mapping boundary:** Selected B2 family: `cap.per_turn_permission`

## Purpose

This durable V1 capability covers a permission or restriction that explicitly resets or is limited once per turn.

## Supported scope

- Includes: a permission or restriction that explicitly resets or is limited once per turn
...
- a one-shot permission with no turn boundary and an ordinary turn trigger

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.per_turn_permission`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.per_turn_permission`
