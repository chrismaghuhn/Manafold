# Capability Specification — rules/mana-ability

**Capability key/version:** `rules/mana-ability@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.mana_ability`

## Purpose

This durable V1 capability covers an activated ability that produces mana and satisfies the rules-defined mana-ability form.

## Supported scope

- Includes: an activated ability that produces mana and satisfies the rules-defined mana-ability form
...
- an effect that adds mana only as a triggered or resolving spell effect

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.mana_ability`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.mana_ability`
