# Capability Specification — rules/shuffle

**Capability key/version:** `rules/shuffle@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.shuffle`

## Purpose

This durable V1 capability covers an instruction that shuffles a library or other stated set of cards.

## Supported scope

- Includes: an instruction that shuffles a library or other stated set of cards
...
- a card merely mentioning a shuffled object without instructing a shuffle

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.shuffle`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.shuffle`
