# Capability Specification — rules/shuffle-self

**Capability key/version:** `rules/shuffle-self@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.shuffle_self`

## Purpose

This durable V1 capability covers a resolving spell or ability that shuffles its own card into its owner's library.

## Supported scope

- Includes: a resolving spell or ability that shuffles its own card into its owner's library
...
- shuffling another library or a card that merely has a shuffle instruction

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.shuffle_self`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.shuffle_self`
