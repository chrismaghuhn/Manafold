# Capability Specification — rules/counters

**Capability key/version:** `rules/counters@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.counters`

## Purpose

This durable V1 capability covers an effect that puts, removes, or tracks counters on a named object.

## Supported scope

- Includes: an effect that puts, removes, or tracks counters on a named object
...
- a word such as counter used as a verb for countering a spell or as unrelated prose

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.counters`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.counters`
...
- Selected B2 family: `cap.counters`
- Selected outlier surfaces: Ajani, Caller of the Pride [planeswalker;loyalty;continuous-ability-grant;tokens]; Grimoire of the Dead [control-change;mass-reanimation;type-color-modification;cross-graveyard].
