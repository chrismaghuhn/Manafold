# Capability Specification — rules/exile

**Capability key/version:** `rules/exile@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.exile`

## Purpose

This durable V1 capability covers an instruction that moves a card or permanent to the exile zone.

## Supported scope

- Includes: an instruction that moves a card or permanent to the exile zone
...
- a reference to an already exiled card, reminder text, or a different zone change

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.exile`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.exile`
