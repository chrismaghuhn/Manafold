# Capability Specification — rules/draw-discard

**Capability key/version:** `rules/draw-discard@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.draw_discard`

## Purpose

This durable V1 capability covers one effect that combines drawing cards and discarding cards as its operative hand operation.

## Supported scope

- Includes: one effect that combines drawing cards and discarding cards as its operative hand operation
...
- separate unrelated draw and discard text or a discard cost

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.draw_discard`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.draw_discard`
- `comprehensive-rules:CR-121-drawing`
