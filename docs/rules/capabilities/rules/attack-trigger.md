# Capability Specification — rules/attack-trigger

**Capability key/version:** `rules/attack-trigger@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.attack_trigger`

## Purpose

This durable V1 capability covers an actual triggered ability whose event condition is a creature or permanent attacking.

## Supported scope

- Includes: an actual triggered ability whose event condition is a creature or permanent attacking
...
- the word attack in a reminder, goad consequence, combat effect, or non-triggered condition

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.attack_trigger`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.attack_trigger`
