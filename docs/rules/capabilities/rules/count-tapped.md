# Capability Specification — rules/count-tapped

**Capability key/version:** `rules/count-tapped@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.count_tapped`

## Purpose

This durable V1 capability covers an effect that counts tapped permanents or creatures as a numeric input.

## Supported scope

- Includes: an effect that counts tapped permanents or creatures as a numeric input
...
- tapping as a cost or a tapped status with no count dependency

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.count_tapped`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.count_tapped`
