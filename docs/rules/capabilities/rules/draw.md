# Capability Specification — rules/draw

**Capability key/version:** `rules/draw@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.draw`

## Purpose

This durable V1 capability covers an instruction that moves one or more cards from a library into a player's hand as card draw.

## Supported scope

- Includes: an instruction that moves one or more cards from a library into a player's hand as card draw
...
- looking at, revealing, searching for, or putting a card into a hand without the draw operation

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.draw`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.draw`
