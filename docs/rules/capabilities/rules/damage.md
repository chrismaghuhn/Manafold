# Capability Specification — rules/damage

**Capability key/version:** `rules/damage@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.damage`

## Purpose

This durable V1 capability covers an instruction that deals damage to a player, creature, planeswalker, or other object.

## Supported scope

- Includes: an instruction that deals damage to a player, creature, planeswalker, or other object
...
- a damage reference in a condition or reminder that does not deal damage

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.damage`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.damage`
