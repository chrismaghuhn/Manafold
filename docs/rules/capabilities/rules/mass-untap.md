# Capability Specification — rules/mass-untap

**Capability key/version:** `rules/mass-untap@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.mass_untap`

## Purpose

This durable V1 capability covers one instruction that untaps multiple permanents, such as untap all or a stated set.

## Supported scope

- Includes: one instruction that untaps multiple permanents, such as untap all or a stated set
...
- attachment, animation, or a single-object untap

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.mass_untap`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.mass_untap`
