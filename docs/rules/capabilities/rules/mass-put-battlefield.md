# Capability Specification — rules/mass-put-battlefield

**Capability key/version:** `rules/mass-put-battlefield@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.mass_put_battlefield`

## Purpose

This durable V1 capability covers one effect that puts multiple cards or permanents directly onto the battlefield.

## Supported scope

- Includes: one effect that puts multiple cards or permanents directly onto the battlefield
...
- single-object battlefield entry and mass return to hand or exile

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.mass_put_battlefield`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.mass_put_battlefield`
...
- Selected B2 family: `cap.mass_put_battlefield`
