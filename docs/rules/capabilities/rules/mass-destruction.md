# Capability Specification — rules/mass-destruction

**Capability key/version:** `rules/mass-destruction@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.mass_destruction`

## Purpose

This durable V1 capability covers one effect that destroys all or a plurality of permanents or objects.

## Supported scope

- Includes: one effect that destroys all or a plurality of permanents or objects
...
- single-target destruction, sacrifice, or a destruction reference without a mass operation

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.mass_destruction`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.mass_destruction`
...
- Selected B2 family: `cap.mass_destruction`
