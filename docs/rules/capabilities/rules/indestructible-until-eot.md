# Capability Specification — rules/indestructible-until-eot

**Capability key/version:** `rules/indestructible-until-eot@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.indestructible_until_eot`

## Purpose

This durable V1 capability covers an effect granting Indestructible through the end of the current turn.

## Supported scope

- Includes: an effect granting Indestructible through the end of the current turn
...
- permanent indestructible, regeneration, or a different temporary duration

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.indestructible_until_eot`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.indestructible_until_eot`
- `comprehensive-rules:CR-613-continuous-effects`
- `comprehensive-rules:CR-702-12-indestructible`
...
- Selected B2 family: `cap.indestructible_until_eot`
