# Capability Specification — rules/destroy

**Capability key/version:** `rules/destroy@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.destroy`

## Purpose

This durable V1 capability covers an instruction that destroys a permanent or other destroyable object.

## Supported scope

- Includes: an instruction that destroys a permanent or other destroyable object
...
- sacrifice, exile, damage, or a reminder-text occurrence of destroy

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.destroy`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.destroy`
...
- Selected B2 family: `cap.destroy`
