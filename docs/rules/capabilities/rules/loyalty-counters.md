# Capability Specification — rules/loyalty-counters

**Capability key/version:** `rules/loyalty-counters@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.loyalty_counters`

## Purpose

This durable V1 capability covers placing, removing, or counting loyalty counters on a planeswalker.

## Supported scope

- Includes: placing, removing, or counting loyalty counters on a planeswalker
...
- ordinary +1/+1 or other counters and loyalty wording without loyalty counters

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.loyalty_counters`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.loyalty_counters`
...
- Selected B2 family: `cap.loyalty_counters`
