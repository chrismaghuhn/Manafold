# Capability Specification — rules/grant-mana-ability

**Capability key/version:** `rules/grant-mana-ability@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.grant_mana_ability`

## Purpose

This durable V1 capability covers an effect that grants a mana-producing activated ability to a permanent.

## Supported scope

- Includes: an effect that grants a mana-producing activated ability to a permanent
...
- a permanent's printed mana ability or a one-shot mana production effect

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.grant_mana_ability`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.grant_mana_ability`
