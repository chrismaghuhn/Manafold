# Capability Specification — rules/upkeep-trigger

**Capability key/version:** `rules/upkeep-trigger@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.upkeep_trigger`

## Purpose

This durable V1 capability covers an actual triggered ability with an upkeep event condition.

## Supported scope

- Includes: an actual triggered ability with an upkeep event condition
...
- the word upkeep in a cost, duration, or non-triggered effect

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.upkeep_trigger`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.upkeep_trigger`
- `comprehensive-rules:CR-503-upkeep-step`
