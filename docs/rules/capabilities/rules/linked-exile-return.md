# Capability Specification — rules/linked-exile-return

**Capability key/version:** `rules/linked-exile-return@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.linked_exile_return`

## Purpose

This durable V1 capability covers a linked pair in which an ability returns the cards exiled by its linked ability.

## Supported scope

- Includes: a linked pair in which an ability returns the cards exiled by its linked ability
...
- an unlinked return from exile or an ordinary linked ability with another consequence

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.linked_exile_return`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.linked_exile_return`
- `comprehensive-rules:CR-406-exile`
- `comprehensive-rules:CR-607-linked-abilities`
