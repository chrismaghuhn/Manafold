# Capability Specification — rules/life-drain

**Capability key/version:** `rules/life-drain@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.life_drain`

## Purpose

This durable V1 capability covers one effect in which an opponent loses life while that same effect gives life to its controller.

## Supported scope

- Includes: one effect in which an opponent loses life while that same effect gives life to its controller
...
- separate choose-one branches, damage, life payment, or life loss without the paired drain relation

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.life_drain`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.life_drain`
- `comprehensive-rules:CR-119-life`
...
- Selected B2 family: `cap.life_drain`
