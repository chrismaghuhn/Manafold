# Capability Specification — rules/mass-type-change

**Capability key/version:** `rules/mass-type-change@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.mass_type_change`

## Purpose

This durable V1 capability covers one continuous or resolving effect that changes the type of multiple objects as a group.

## Supported scope

- Includes: one continuous or resolving effect that changes the type of multiple objects as a group
...
- a single-object type change or a mass effect that only changes color or power

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.mass_type_change`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.mass_type_change`
...
- Selected B2 family: `cap.mass_type_change`
