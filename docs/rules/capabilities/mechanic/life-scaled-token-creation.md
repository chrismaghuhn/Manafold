# Capability Specification — mechanic/life-scaled-token-creation

**Capability key/version:** `mechanic/life-scaled-token-creation@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-interaction-maintainer
**Mapping boundary:** Selected B2 family: `cap.life_scaled_token_creation`

## Purpose

This durable V1 capability covers token quantity or token characteristics scaled by a player's life total.

## Supported scope

- Includes: token quantity or token characteristics scaled by a player's life total
...
- life gain/loss without token creation and fixed token creation

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.life_scaled_token_creation`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.life_scaled_token_creation`
...
- Selected B2 family: `cap.life_scaled_token_creation`
