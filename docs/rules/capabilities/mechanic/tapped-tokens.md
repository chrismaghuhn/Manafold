# Capability Specification — mechanic/tapped-tokens

**Capability key/version:** `mechanic/tapped-tokens@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-interaction-maintainer
**Mapping boundary:** Selected B2 family: `cap.tapped_tokens`

## Purpose

This durable V1 capability covers creation of tokens that explicitly enter the battlefield tapped.

## Supported scope

- Includes: creation of tokens that explicitly enter the battlefield tapped
...
- a token that taps later or a tapped source permanent

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.tapped_tokens`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.tapped_tokens`
...
- Selected B2 family: `cap.tapped_tokens`
