# Capability Specification — mechanic/scry

**Capability key/version:** `mechanic/scry@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.scry`

## Purpose

This durable V1 capability covers the Scry operation that looks at the top cards of a library and orders them or puts them on the bottom.

## Supported scope

- Includes: the Scry operation that looks at the top cards of a library and orders them or puts them on the bottom
...
- ordinary library search, reveal, draw, or bottom placement without Scry

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.scry`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.scry`
- `comprehensive-rules:CR-401-library`
- `comprehensive-rules:CR-701-22a-scry`
