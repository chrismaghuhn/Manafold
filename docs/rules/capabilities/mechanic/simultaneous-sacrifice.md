# Capability Specification — mechanic/simultaneous-sacrifice

**Capability key/version:** `mechanic/simultaneous-sacrifice@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-interaction-maintainer
**Mapping boundary:** Selected B2 family: `cap.simultaneous_sacrifice`

## Purpose

This durable V1 capability covers one instruction that sacrifices multiple objects simultaneously as one event.

## Supported scope

- Includes: one instruction that sacrifices multiple objects simultaneously as one event
...
- sequential sacrifices, an additional sacrifice cost, or a threshold based on past sacrifices

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.simultaneous_sacrifice`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.simultaneous_sacrifice`
...
- Selected B2 family: `cap.simultaneous_sacrifice`
