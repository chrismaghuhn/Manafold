# Capability Specification — mechanic/kicker

**Capability key/version:** `mechanic/kicker@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `medium`
**M3 implementation owner:** rules-maintainer
**Mapping boundary:** Selected B2 family: `cap.kicker`

## Purpose

This durable V1 capability covers the Kicker keyword and its optional additional casting cost.

## Supported scope

- Includes: the Kicker keyword and its optional additional casting cost
...
- any additional cost that is not the Kicker procedure

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.kicker`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.kicker`
- `comprehensive-rules:CR-702-33-kicker`
