# Capability Specification — mechanic/bounded-control-restoration

**Capability key/version:** `mechanic/bounded-control-restoration@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-interaction-maintainer
**Mapping boundary:** Selected B2 family: `cap.bounded_control_restoration`

## Purpose

This durable V1 capability covers an effect that restores control of an object only within its stated boundary or controller set.

## Supported scope

- Includes: an effect that restores control of an object only within its stated boundary or controller set
...
- unbounded control change, ownership change, or a generic control-changing effect

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.bounded_control_restoration`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.bounded_control_restoration`
...
- Selected B2 family: `cap.bounded_control_restoration`
