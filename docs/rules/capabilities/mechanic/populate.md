# Capability Specification — mechanic/populate

**Capability key/version:** `mechanic/populate@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** rules-interaction-maintainer
**Mapping boundary:** Selected B2 family: `cap.populate_token_copy`

## Purpose

This durable V1 capability covers the Populate operation that creates a token copy of a creature token you control.

## Supported scope

- Includes: the Populate operation that creates a token copy of a creature token you control
...
- ordinary token creation, copying a nontoken permanent, or copying a spell

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.populate_token_copy`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.populate_token_copy`
- `comprehensive-rules:CR-111-tokens`
- `comprehensive-rules:CR-701-36a-populate`
...
- Selected B2 family: `cap.populate_token_copy`
