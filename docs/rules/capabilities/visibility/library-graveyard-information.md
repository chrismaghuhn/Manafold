# Capability Specification — visibility/library-graveyard-information

**Capability key/version:** `visibility/library-graveyard-information@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** information-safety-maintainer
**Mapping boundary:** Selected B2 family: `cap.library_graveyard_information`

## Purpose

This durable V1 capability covers an effect whose information boundary jointly depends on library cards and graveyard cards.

## Supported scope

- Includes: an effect whose information boundary jointly depends on library cards and graveyard cards
...
- a library-only or graveyard-only operation

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.library_graveyard_information`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.library_graveyard_information`
