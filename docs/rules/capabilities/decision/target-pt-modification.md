# Capability Specification — decision/target-pt-modification

**Capability key/version:** `decision/target-pt-modification@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.target_pt_modification`

## Purpose

This durable V1 capability covers a targeted effect that modifies a target's power and toughness.

## Supported scope

- Includes: a targeted effect that modifies a target's power and toughness
...
- untargeted team modification, base setting, or a target that receives another kind of effect

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.target_pt_modification`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.target_pt_modification`
...
- Selected B2 family: `cap.target_pt_modification`
