# Capability Specification — decision/target-restriction

**Capability key/version:** `decision/target-restriction@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.target_restriction`

## Purpose

This durable V1 capability covers a target contract restricted by a stated characteristic, zone, type, or controller.

## Supported scope

- Includes: a target contract restricted by a stated characteristic, zone, type, or controller
...
- a generic target and a non-targeted eligibility restriction

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.target_restriction`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.target_restriction`
