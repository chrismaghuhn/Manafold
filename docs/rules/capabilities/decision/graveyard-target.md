# Capability Specification — decision/graveyard-target

**Capability key/version:** `decision/graveyard-target@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** decision-maintainer, information-safety-maintainer
**Mapping boundary:** Selected B2 family: `cap.graveyard_target`

## Purpose

This durable V1 capability covers a target selection whose candidate objects are cards in a graveyard.

## Supported scope

- Includes: a target selection whose candidate objects are cards in a graveyard
...
- a graveyard reference without targeting or a target in another zone

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.graveyard_target`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.graveyard_target`
...
- Selected B2 family: `cap.graveyard_target`
