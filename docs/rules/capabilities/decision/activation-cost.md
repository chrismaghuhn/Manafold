# Capability Specification — decision/activation-cost

**Capability key/version:** `decision/activation-cost@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.activation_cost`

## Purpose

This durable V1 capability covers the cost portion of an activated ability, including its mana, tap, discard, sacrifice, or other payment.

## Supported scope

- Includes: the cost portion of an activated ability, including its mana, tap, discard, sacrifice, or other payment
...
- a spell's additional cost or an effect that merely changes another cost
