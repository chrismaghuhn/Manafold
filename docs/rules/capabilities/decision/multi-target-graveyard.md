# Capability Specification — decision/multi-target-graveyard

**Capability key/version:** `decision/multi-target-graveyard@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `critical`
**M3 implementation owner:** decision-maintainer, information-safety-maintainer
**Mapping boundary:** Selected B2 family: `cap.multi_target_graveyard`

## Purpose

This durable V1 capability covers a target contract selecting multiple cards or objects from graveyards.

## Supported scope

- Includes: a target contract selecting multiple cards or objects from graveyards
...
- one graveyard target, multiple non-graveyard targets, or a non-targeted graveyard selection

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.multi_target_graveyard`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.multi_target_graveyard`
