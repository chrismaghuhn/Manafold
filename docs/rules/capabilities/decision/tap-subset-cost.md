# Capability Specification — decision/tap-subset-cost

**Capability key/version:** `decision/tap-subset-cost@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.tap_subset_cost`

## Purpose

This durable V1 capability covers an activated cost requiring the player to tap a chosen subset of creatures or permanents.

## Supported scope

- Includes: an activated cost requiring the player to tap a chosen subset of creatures or permanents
...
- tapping as an effect, tapping all, or an unchosen fixed tap cost

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.tap_subset_cost`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.tap_subset_cost`
...
- Selected B2 family: `cap.tap_subset_cost`
- Selected outlier surfaces: Gravespawn Sovereign [control-change;tap-subset-cost;reanimation].
