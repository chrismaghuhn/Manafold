# Capability Specification — decision/tap-another-creature-cost

**Capability key/version:** `decision/tap-another-creature-cost@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.tap_another_creature_cost`

## Purpose

This durable V1 capability covers an activated cost requiring the player to tap another creature.

## Supported scope

- Includes: an activated cost requiring the player to tap another creature
...
- tapping the source itself, tapping as an effect, or a cost that taps an arbitrary permanent

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.tap_another_creature_cost`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.tap_another_creature_cost`
