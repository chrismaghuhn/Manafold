# Capability Specification — decision/mode-choice

**Capability key/version:** `decision/mode-choice@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.mode_choice`

## Purpose

This durable V1 capability covers a choose-one, choose-one-or-more, or equivalent mode-selection decision.

## Supported scope

- Includes: a choose-one, choose-one-or-more, or equivalent mode-selection decision
...
- a target choice, numeric choice, or an implicit branch without a mode selection

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.mode_choice`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.mode_choice`
