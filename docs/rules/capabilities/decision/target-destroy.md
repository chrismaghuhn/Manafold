# Capability Specification — decision/target-destroy

**Capability key/version:** `decision/target-destroy@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.target_destroy`

## Purpose

This durable V1 capability covers a targeted instruction that destroys a target permanent or object.

## Supported scope

- Includes: a targeted instruction that destroys a target permanent or object
...
- untargeted destruction, exile, sacrifice, or the word target in unrelated text

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.target_destroy`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.target_destroy`
