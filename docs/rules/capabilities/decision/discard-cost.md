# Capability Specification — decision/discard-cost

**Capability key/version:** `decision/discard-cost@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.discard_cost`

## Purpose

This durable V1 capability covers discarding a card as an explicit cost before the colon or casting instruction resolves.

## Supported scope

- Includes: discarding a card as an explicit cost before the colon or casting instruction resolves
...
- discard as an effect, hand-size cleanup, or a discard reference outside a cost

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.discard_cost`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.discard_cost`
- `comprehensive-rules:CR-118-costs`
- `comprehensive-rules:CR-701-9-discard`
...
- Selected B2 family: `cap.discard_cost`
