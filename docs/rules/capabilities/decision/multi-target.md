# Capability Specification — decision/multi-target

**Capability key/version:** `decision/multi-target@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.multi_target`

## Purpose

This durable V1 capability covers an effect that selects two or more targets or a variable plurality of targets.

## Supported scope

- Includes: an effect that selects two or more targets or a variable plurality of targets
...
- a single target or multiple non-targeted objects

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.multi_target`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.multi_target`
