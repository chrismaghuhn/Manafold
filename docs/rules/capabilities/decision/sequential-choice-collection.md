# Capability Specification — decision/sequential-choice-collection

**Capability key/version:** `decision/sequential-choice-collection@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.sequential_choice_collection`

## Purpose

This durable V1 capability covers an effect that collects multiple choices in a stated sequence.

## Supported scope

- Includes: an effect that collects multiple choices in a stated sequence
...
- a simultaneous choice, a single choice, or an unordered plurality without sequence

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.sequential_choice_collection`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.sequential_choice_collection`
...
- Selected B2 family: `cap.sequential_choice_collection`
