# Capability Specification — decision/additional-sacrifice-cost

**Capability key/version:** `decision/additional-sacrifice-cost@0.1.0`
**Lifecycle:** `specified`
**Information risk:** `high`
**M3 implementation owner:** decision-maintainer
**Mapping boundary:** Selected B2 family: `cap.additional_sacrifice_cost`

## Purpose

This durable V1 capability covers sacrificing a permanent as an additional cost to cast a spell.

## Supported scope

- Includes: sacrificing a permanent as an additional cost to cast a spell
...
- sacrifice during resolution, an activation cost, or an ordinary sacrifice effect

## Authority

- `b1-final:sources/m2_5/closures/B1/official_authority_citations.v3.json#cap.additional_sacrifice_cost`
- `b2-boundary:sources/m2_5/closures/B2/requirement_family_catalog.v1.json#cap.additional_sacrifice_cost`
