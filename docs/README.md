...
Accepted ADRs 0039 and 0040 contain the M2 decision and information/V3 compatibility architecture; accepted ADR 0041 records the post-`M2.Final` capability-oriented semantic-ownership decision; accepted ADR 0042 records the ContextApplicationV2 reviewed-context bridge architecture; accepted ADR 0043 records the ContextApplicationV2 supersession lineage, revocation, and currentness semantics; accepted ADR 0044 records the ContextApplicationV2 Slice 6 Host-Binding integration clarifications; accepted ADR 0045 records the Reviewed Participant-Role Bridge architecture; accepted ADR 0046 records the B2 closure-only v2 successor and explicit current-root adoption architecture; accepted ADR 0047 records the M2.5 scope-restoration and M3-entry boundary. ADRs record intent; executable behavior remains evidence-driven.
