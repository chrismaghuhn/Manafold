...
Accepted ADRs 0039 and 0040 contain the M2 decision and information/V3 compatibility architecture; accepted ADR 0041 records the post-`M2.Final` capability-oriented semantic-ownership decision; accepted ADR 0042 records the ContextApplicationV2 reviewed-context bridge architecture; accepted ADR 0043 records the ContextApplicationV2 supersession lineage, revocation, and currentness semantics. ADRs record intent; executable behavior remains evidence-driven.
