...
RED proves paired states differing only in unauthorized hidden facts have identical player-visible canonical bytes, legal candidates, event sequence, PlayerStep and errors; and trusted-ID renaming that preserves public relationships leaves player-visible semantic bytes invariant.
