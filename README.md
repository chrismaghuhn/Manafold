...
- **M3 Block 1:** bounded S3.A implementation is a candidate pending exact-head review; the nonterminal final-Order Reference path remains blocked until Basic Priority in Block 2
...
- **Playable engine:** no
- **Real Magic semantics:** S1 is covered; S2 is implemented / not covered; bounded S3.A batch, APNAP, and production-identity work is a candidate pending exact-head review; no S3.A lifecycle promotion is claimed
