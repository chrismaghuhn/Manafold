//! Detached historical V3 digest primitives.
//!
//! V3 is no longer a producer for the current `EngineState`. The detached
//! input remains available only for historical verification paths; current
//! state identity is produced by `digest_v4`.
